...
import pandas as pd 
import random   
>>>>>>> c12d4bdd62e5e07894c1b93991897313d0600e08
...
groq_client = Groq(
    api_key=os.getenv("GROQ_API_KEY")  # Replace with your Groq key
)
TICKETMASTER_API_KEY = os.getenv("TM_API_KEY") # Get from developer.ticketmaster.com
CALENDARIFIC_API_KEY = os.getenv("CC_API_KEY") # Get from calendarific.com
<<<<<<< HEAD
...
<<<<<<< HEAD
    user_id = data.get('user_id')  # ← ADD THIS to get from frontend
    
    # ✅ NEW: Get user's past search history for incremental learning
=======
    user_id = data.get('user_id')
...
"""
    ...
    try:
<<<<<<< HEAD
        # Your existing Groq API call (keep it!)
=======
...
<<<<<<< HEAD
        # ✅ NEW: Save this search to history for future learning
=======
